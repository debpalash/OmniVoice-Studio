...
### Fixed
- Desktop startup, Retry, reset, uninstall, shutdown, and crash recovery now share one backend lifecycle owner, so overlapping starts cannot create a second process, delete its live environment, or leave it orphaned on exit (#1635) — thanks @Xohaibxobi!
