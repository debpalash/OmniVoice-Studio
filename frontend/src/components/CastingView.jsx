    ...
    <div className="casting-view">
      <div className="casting-view__header">
        <h3 className="casting-view__title">
          <User size={14} /> {t('dub.speaker_casting')}
        </h3>
        <div className="casting-view__actions">
          <button
            className="casting-view__auto-btn"
            onClick={autoAssignAll}
            title={t('dub.auto_cast_title')}
          >
            <Shuffle size={12} /> {t('dub.auto_cast')}
          </button>
          {allAssigned && (
            <span className="casting-view__badge">
              <Check size={10} /> {t('dub.all_cast')}
            </span>
          )}
        </div>
      </div>
      ...
      <div className="casting-view__grid">
        {speakers.map((speaker) => {
          ...
          const assignedProfile = isAuto
            ? { name: `🎤 ${t('dub.from_video_lower')} (${autoName})`, type: 'clone' }
            ...
            >
              ...
              <div className="casting-row__speaker">
                ...
                <div className="casting-row__info">
                  ...
                  <span className="casting-row__meta">
                    {speaker.segments_count || 0} {t('dub.segments')}
                  </span>
                </div>
              </div>
              ...
              <div className="casting-row__voice">
                ...
                >
                  {assignedProfile ? (
                    ...
                    <>
                      <span className="casting-row__unassigned">{t('dub.assign_voice')}</span>
                    </>
                  )}
                  <ChevronDown size={12} />
                </button>
              ...
              {currentAssignment && onPreview && (
                <button
                  ...
                  title={t('dub.preview_voice_title')}
                >
                  <Volume2 size={12} />
                </button>
              )}
