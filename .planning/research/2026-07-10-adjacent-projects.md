...
Owner-requested research on four neighboring projects, read against OmniVoice
...
6. **RTVC comparison/migration page** (§1): marketing, not engineering;
   cheap and honest.

*Method note: compiled from four parallel research passes over the repos'
